...
This table has **one** ✅ pillar today (Price/freedom); eight hold at ➖ —
genuinely usable daily-driver capability, short of incumbent parity on named
residuals (**Sketching & constraints, Part modeling**, Assemblies, Interop,
...
(Collaboration, Extensibility, Agent access). Two of the eight — Sketching and
Part modeling — were ✅ as of this morning; a founder-directed product audit
landed hours later, tested this table's own claims against the running app,
and both did not survive contact (full evidence in each row's Notes, dated
...
Last re-scored 2026-08-21 (vision-steward), **fourteenth pass this cycle**,
