...
Last re-scored 2026-07-15 (vision-steward), eighth pass this cycle, against
git log through `e8ecce9` (assembly-mode frontend). **Assemblies flipped
❌→➖**: the v1 MVP landed end-to-end this batch — document model (`fab5115`,
